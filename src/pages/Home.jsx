           ...
           <section className="py-4 mt-6 bg-gradient-to-r from-amber-50 to-orange-300">
            <div className="container flex flex-col md:flex-row">
                <div className="flex flex-col items-center justify-center rounded-lg lg:w-1/2">
                    <img src={cookingImage} alt="cooking" width={500} className="rounded-lg" />
                        ...
                        <div className="flex flex-wrap space-y-6 md:space-y-0">
                            ...
                            <div className="flex flex-col items-center text-center p-4 md:w-1/3">
                                    ...
                                    <div className="flex-grow">
                                        ...
                                        <p className="text-base leading-relaxed">
                                            Pick up the order from your nearest store or get it delivered to your doorstep.
                                        </p>
                                    </div>
                            ...
                            <div className="p-4 md:w-1/3 " key={item._id}>
                                <Link to={`/products/${item._id}`}>
                                    <div className="overflow-hidden border rounded-lg border-opacity-60">
                                        <img src={item.image} alt={item.productName} className="object-cover object-center w-full lg:h-48 md:h-36" />
