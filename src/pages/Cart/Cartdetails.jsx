...
function CartDetails(){
    ...
    useEffect(()=>{
       ...
       cartsData?.items?.reduce((sum, item) => sum + item.quantity, 0)
    ]);
  ...
  <div className="flex items-center border rounded-md">
    ...
    <button
      ...
      className="px-2 py-1 text-lg font-bold text-gray-600 hover:text-white hover:bg-gray-600 transition rounded-l-md disabled:opacity-50"
    ...
    <button
      ...
      className="px-2 py-1 text-lg font-bold text-gray-600 hover:text-white hover:bg-gray-600 transition rounded-r-md disabled:opacity-50"
